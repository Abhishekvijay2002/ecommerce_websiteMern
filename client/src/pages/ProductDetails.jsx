...
import { addToCart, Getproductbyid } from "../services/UserService";
...
const ProductDetails = () => {
  ...
  const addCourseToCart = async (productId) => {
    try {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex mt-4 space-x-2">
              {images.map((img, index) => (
                <img
                  ...
                  className={`w-30 h-30 object-cover rounded cursor-pointer border-2 ${selectedImage === index ? "border-black" : "border-transparent"
                    }`}
                />
              ))}
            </div>
          ...
          <div>
            ...
            <div className="mt-4 flex space-x-2">
              <button onClick={() => addCourseToCart(product._id)} className="px-4 py-2 bg-black text-white rounded">Add to Cart</button>
